...
export default function UserList(){
    ...
    useEffect(() => {
        axios.get( process.env.REACT_APP_SERVER_HOST_API + '/Movies' , {params : {use_yn: 'Y',_sort:'rgstr_time',_order:'DESC' }})
    ...
    const handleDelete = (row:any) => () => {
        ...
        */
        ...
        axios.patch( process.env.REACT_APP_SERVER_HOST_API + "/Movies/" + row.id , {
            use_yn : 'N' ,  
    ...
    const goMoviesView = async (e : React.MouseEvent<HTMLSpanElement>) => {
        ...
        await axios.patch( process.env.REACT_APP_SERVER_HOST_API + '/Movies/'+id ,{'visits++' : 1})
