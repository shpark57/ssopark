...
export default function UserList(){
    ...
    useEffect(() => {
        axios.get( process.env.REACT_APP_CLIENT_HOST + '/api/Users' , {params : {use_yn: 'Y',_sort:'last_login',_order:'DESC' }})
        ...
        showModal({
            ...
            modalProps: {
                ...
                handleConfirm: () => {
                    ...
                    axios.patch( process.env.REACT_APP_CLIENT_HOST + "/api/Users/" + row.id , {
                        use_yn : 'N' ,
