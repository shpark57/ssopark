...
export default function UserList(){
    ...
    useEffect(() => {
        axios.get( process.env.REACT_APP_SERVER_HOST + '/Users' , {params : {use_yn: 'Y',_sort:'last_login',_order:'DESC' }})
        ...
        showModal({
            ...
            modalProps: {
                ...
                handleConfirm: () => {
                    ...
                    axios.patch( process.env.REACT_APP_SERVER_HOST + "/Users/" + row.id , {
                        use_yn : 'N' ,
